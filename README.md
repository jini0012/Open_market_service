...
- 장바구니 기능 구현 (수량 수정 및 주문하기 기능 구현 예정)
...
- MPA 사용
  ...
  |  🖥️  |   로그인   |  회원가입   | 상품 목록  | 상품 상세  | 서버 에러  | 장바구니  |
  | :--: | :--------: | :---------: | :--------: | :--------: | :--------: | --------- |
  | Page | login.html | signup.html | index.html | goods.html | error.html | cart.html |
...
- 장바구니 페이지 (추가)
  ...
  |     4      |     총 금액 UI      | 장바구니 내의 총 상품금액 / 배송비 / 결제 예정 금액 UI 구현                           | (추가)✅ |
